...
/**
 * Calcul pur de la trésorerie prévisionnelle (Trésorerie) : projections de flux, suggestions
 * budgétaires, moyennes réelles constatées sur le pointage bancaire. Aucune dépendance Spring
 * Web, aucun état — instanciable et testable indépendamment de la couche HTTP.
 *
 * Point 8 de l'audit ({@code audit-mitigation-plan.md}), incrément 2/2 : même traitement que
 * {@code OverviewCalculationService} pour {@code TresorerieServiceImpl} (869 lignes, dont
 * seulement cinq méthodes `@Override` exposant les endpoints REST). Déplacement de code à
 * l'identique, sans réécriture fonctionnelle.
 */
