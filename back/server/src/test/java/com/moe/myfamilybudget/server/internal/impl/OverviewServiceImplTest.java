...
import com.moe.myfamilybudget.server.internal.dto.CashflowYearDto;
...
class OverviewServiceImplTest {
    ...
    void testBuildOverview_NullData() {
        assertThatThrownBy(() -> overviewService.buildOverview(null, false))
            ...
            .hasMessage("BudgetDataModel cannot be null");
    }
    ...
    void testBuildOverview_NominalCase() {
        ...
        IncomeModel income1 = new IncomeModel("inc_1", "Salaire 1", new BigDecimal("3500"), "2026-01-01", "2048-12-31", new BigDecimal("0.01"), "cat_1", null);
        ChargeModel charge1 = new ChargeModel("chg_1", "Loyer", new BigDecimal("1200"), "2026-01-01", "2048-12-31", new BigDecimal("0.02"), "cat_2", null);

        PlacementModel placement1 = new PlacementModel(
        ...
        RealEstateModel realEstate1 = new RealEstateModel(
            "re_1", "RP Paris", "Résidence Principale", new BigDecimal("350000"), 2026, new BigDecimal("0.02"), null
        );

        RetirementModel.RetirementPersonModel person1 = new RetirementModel.RetirementPersonModel(
            "p_1", "Moe", 1985, "Salaire 1", 120, "2025-12-31",
            List.of(
                new RetirementModel.SalaryHistoryModel(2023, new BigDecimal("42000")),
                new RetirementModel.SalaryHistoryModel(2024, new BigDecimal("44000")),
                new RetirementModel.SalaryHistoryModel(2025, new BigDecimal("46000"))
            ),
    ...
    void testRetirementProjection() {
        ...
        IncomeModel income = new IncomeModel("inc_1", "Salaire Moe", new BigDecimal("4000"), "2026-01-01", "2048-12-31", new BigDecimal("0.01"), "cat_1", null);
